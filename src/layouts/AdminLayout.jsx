...
import { FaUser, FaTachometerAlt, FaUsers, FaClipboardList, FaTint, FaHospital, FaSignOutAlt, FaComments } from 'react-icons/fa';
...
const navLinks = [
  ...
  { to: '/admin/forum', icon: <FaComments />, text: 'Quản lý Diễn đàn' },
